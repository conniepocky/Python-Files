...
black = (0,0,0)
red = (255,0,0)
light_red = (220,110,110)
yellow = (200,200,0)
light_yellow = (255,231,0)
light_green = (0,255,0)
green = (34,177,76)
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("Tanks :D",green,-100,size="large")
        message_to_screen("You have to shoot and destroy",black,-30)
        message_to_screen("the enemy tank before they destroy you :0",black,10)
